...
<script type="text/javascript">
		$(document).ready(function(){
			...
			{
				$.ajax({
					url:"<?php echo e(route('videoshow.action')); ?>",
					method:'GET',
					data:{query:query},
					dataType:'json',
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/blogger/resources/views/frontend/video.blade.php ENDPATH**/ ?>