		...
		<div class="col-lg-4 d-lg-block d-md-none d-sm-none">
			<div class="row">
				<div class="col-lg-8">
					...
					<p>Date of Birth <span>19/8/98</span></p>
					<p>Address <span>Yangon</span></p>
				</div>
				<div class="col-lg-4">
			...
			<div class="row">
				<div class="col-lg-8">
					...
					<p>Phone <span>09-632562048</span></p>
					<p>Email <span> uuu@gmail.com</span></p>
				</div>
				<div class="col-lg-4">
			...
			<div class="row">
				<div class="col-lg-8">
					...
					<img src="{{asset('frontendtemplate/bloggertemplate/images/bg_1.jpg')}}" class="coverphoto">
				</div>
				<div class="col-lg-4">
		...
		<div class="col-lg-6 col-md-12 col-sm-12 d-block">
			<div class="card shadow-lg p-3 mb-5 bg-white rounded">
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-3">
						<img src="{{asset('frontendtemplate/bloggertemplate/images/staff-2.jpg')}}" class="img-fluid blogger_img">
					</div>
					...
					<div class="col-md-6 col-lg-6 col-sm-6">
						<img src="{{asset('frontendtemplate/bloggertemplate/images/bg_1.jpeg')}}" class="img-fluid post-img ml-1">
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6">
						<img src="{{asset('frontendtemplate/bloggertemplate/images/bg_1.jpeg')}}" class="img-fluid post-img ml-1">
					</div>
					<div class="col-lg-3 col-md-3 col-sm-3 ml-lg-5 mt-3">
						<span style="font-size: 15px;"><i class="far fa-heart" style="font-size:15px;"></i>&nbsp;15&nbsp;Likes</span>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 mt-2 mt-3">
						<span style="font-size: 15px;"><i class="far fa-comment-alt" style="font-size: 15px;"></i>&nbsp;15&nbsp;Comments</span>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-3 mt-2 mt-3">
						<span style="font-size: 15px;"><i class="far fa-bookmark" style="font-size: 15px;"></i>&nbsp;15&nbsp;Saves</span>
					</div>
				</div>
			</div>
			<div class="card shadow-lg p-3 mb-5 bg-white rounded">
				<div class="row">
					...
					<div class="col-md-12 col-lg-12 col-sm-12 ml-lg-5 ml-md-3 ml-sm-3">
						<iframe width="390" height="230" src="https://www.youtube.com/embed/trML2M2Mb_g" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-3 ml-lg-5 mt-3">
						<span style="font-size: 15px;"><i class="far fa-heart" style="font-size:15px;"></i>&nbsp;15&nbsp;Likes</span>
					</div>
			...
			<div class="card shadow-lg p-3 mb-5 bg-white rounded">
				<div class="row">
					...
					<div class="col-md-12 col-lg-12 col-sm-12 ml-lg-5 ml-md-3 ml-sm-3">
						<iframe width="390" height="230" src="https://www.youtube.com/embed/Zu1dNK0imzQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-3 ml-lg-5 mt-3">
						<span style="font-size: 15px;"><i class="far fa-heart" style="font-size:15px;"></i>&nbsp;15&nbsp;Likes</span>
					</div>
