...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
	...
	<tbody >
		...
		<tr>
			...
			{{--<td><a href="{{route('userlist.show',$row->id)}}" class="btn btn-primary" style="display: inline;"><i class="fas fa-user-check"></i> </a>--}}
			<td>
			<form method="POST" action="{{route('userlist.destroy',$row->id)}}" onsubmit="return confirm('Are you sure Delete this user?')">
				@csrf
				@method('DELETE')
